...
<title>写博客页面</title>
    ...
    <link rel="stylesheet" type="text/css" href="${pageContext.request.contextPath}/static/wangEditor/iplugins/highlight/styles/github.css">

    <script type="text/javascript" src="${pageContext.request.contextPath}/static/jquery-easyui-1.3.3/jquery.min.js"></script>
    <script type="text/javascript" src="${pageContext.request.contextPath}/static/jquery-easyui-1.3.3/jquery.easyui.min.js"></script>
    <script type="text/javascript" src="${pageContext.request.contextPath}/static/jquery-easyui-1.3.3/locale/easyui-lang-zh_CN.js"></script>

    <script type="text/javascript" src="${pageContext.request.contextPath}/static/wangEditor/wangEditor.js"></script>
    ...
    <!-- highlight主题CSS -->
    <link rel="stylesheet" type="text/css" href="${pageContext.request.contextPath}/static/wangEditor/iplugins/highlight/styles/atom-one-dark-reasonable.css">
    <!-- wangEditor v3代码高亮插件CSS -->
    <link rel="stylesheet" type="text/css" href="${pageContext.request.contextPath}/static/wangEditor/iplugins/highlight/highlight-wangEditor.css">
    <!-- highlight库JS -->
    <script type="text/javascript" src="${pageContext.request.contextPath}/static/wangEditor/iplugins/highlight/highlight.pack.js"></script>
    <!-- wangEditor 3代码高亮插件JS -->
    <script type="text/javascript" src="${pageContext.request.contextPath}/static/wangEditor/iplugins/highlight/highlight-wangEditor.min.js"></script>
