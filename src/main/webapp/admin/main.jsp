...
<script type="text/javascript">
	...
	function refreshSystem() {
		$.post("${pageContext.request.contextPath}/admin/system/refreshSystem.do",{},function (result) {
			...
			if(result.success){
				$.messager.alert("系统提示","已经成功刷新系统缓存!");
			}else{
	...
	function modifyPassword() {
		$("#fm").form("submit",{
			url:url,
			Onsubmit:function () {
				var newPassword = $("#newPassrowd").val();
	...
	<table style="padding: 5px" width="100%">
		<tr>
			<td style="padding-top: 16px" valign="middle" align="left" width="50%">
				<span style="font-size: large; ">&nbsp;&nbsp;<strong>个人博客系统</strong></span>
			</td>
			<td style="padding-top: 16px" valign="middle" align="right" width="50%">
				<font size="3">&nbsp;&nbsp;<strong>欢迎：</strong>${currentUser.userName}</font>
				<span style="font-size: large;"><a href="${pageContext.request.contextPath}/index.do" target="_blank"><strong>|博客首页</strong></a></span>
			</td>
		</tr>
	</table>
</div>
...
<div region="west" style="width: 200px" title="导航菜单" split="true">
	<div class="easyui-accordion" data-options="fit:true,border:false">
		...
		<div title="常用操作"  data-options="iconCls:'icon-bkgl'" style="padding:10px;">
