...
(function( root, factory ) {
     ...
     * @fileOverview �����ļ��ϴ���ء�
     */
    define('widgets/com.blog.upload',[
        'base',
        'uploader',
        'file',
        'lib/transport',
        ...
        Uploader.register({
             ...
             * @grammar com.blog.upload() => undefined
             * @method com.blog.upload
             * @for  Uploader
             */
            start: function() {
                var me = this;
    ...
    define('widgets/validator',[
         ...
         * @event error
         * @param {String} type �������͡�
         * @description ��validate��ͨ��ʱ���������ʹ����¼�����ʽ֪ͨ�����ߡ�ͨ��`com.blog.upload.on('error', handler)`���Բ��񵽴������Ŀǰ�����´�������ض�����������ʹ�����
         *
